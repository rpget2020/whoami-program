...
export const about = {
  growth: [
    '어릴 때부터 새로운 기술을 배우고 원리를 이해하는 것을 좋아했습니다. 대학에서 정보통신공학을 전공하며 소프트웨어 개발에 흥미를 느꼈고, 단순히 프로그램을 만드는 것을 넘어 사용자가 실제로 활용하는 서비스를 개발하는 개발자가 되고자 노력했습니다.',
    {
      segments: [
        { text: '최근에는 신사업 프로젝트(전자서명 웹서비스 ' },
        {
          link: {
            label: '유비컨텐츠',
            url: 'https://ubicontent.co.kr/',
        ...
        {
          text: ')를 수행하며 기술적 난관에 부딪힐 때마다 포기하지 않고 원인을 분석하고 해결하는 습관을 길러왔습니다. 특히 서비스 후에는 고객사별 요구사항이 다른 시스템 연동 업무를 수행하면서 문제를 끝까지 파고들어 해결하는 책임감과 끈기를 갖추게 되었습니다.',
        },
      ],
    },
  ],
